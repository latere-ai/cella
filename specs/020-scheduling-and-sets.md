...
| The scheduler admits in priority, then smallest CPU sum per subject, then arrival, with three subjects and mixed priorities | `TestSchedulerHonorsQueueOrder`, `TestAHeadThatDoesNotFitBlocks` | built ([[057-scheduling-queue]]) |
