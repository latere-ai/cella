...
| Placement admits against the lesser of `spec.capacity` and the live workers' reports; `capabilities` is the intersection | `TestWorkerCapacityAndCapabilities` | the intersection is built, [[051-environments-and-workers]]; the capacity half waits on [[020-scheduling-and-sets]]'s admission |
