...
| [063](063-k8s-attach.md) | Kubernetes attach: a terminal and exec with stdin over the pods/exec subresource | medium | in-progress | 004, 008, 012, 014, 015, 031, 034, 036 |
