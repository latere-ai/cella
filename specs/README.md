...
| [058](058-preemption.md) | Preemption: a higher head stops preemptible sandboxes, a victim waits again in its place, and the bound on how often | medium | in-progress | 003, 005, 009, 017, 020, 031, 038, 057 |
...
| [058-preemption.md](058-preemption.md) | in-progress | Preemption on a queued environment: victims by priority, cpu and age, the requeue that keeps a victim's place and disk, `status.preemptions` and `CELLA_MAX_PREEMPTIONS`, `cella_preemptions_total`, and the pool proved behind the authorizer |
